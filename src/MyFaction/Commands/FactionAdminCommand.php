...
class FactionAdminCommand implements CommandExecutor {
	...
	public function onCommand(CommandSender $sender, Command $command, $label, array $args) {
		...
		switch(array_shift($args)) {
			...
			case "invite":
				...
				$isInvited = $this->plugin->getInvite($nickname);
				
				if($isInvited == null){
					$sender->sendMessage($this->language->getMessage('invite_already'));
					return;
				}
				
				$this->plugin->pendInvite($player, $senderData['factionName']);
				$sender->sendMessage($this->language->getMessage('faction_sent', ['{player}'], [$nickname]));
				$player->sendMessage($this->language->getMessage('faction_invited', ['{faction}', '{issuer}'], [$senderData['factionMask'], $senderName]));
			break;
	...
	private function detectRank($level) {
